                    ...
                    <div className="row animated fadeIn slow">
                        <div className="col-md-4">
                            {heroe.nombre === 'Aquaman' &&
                                    <img src={require('../../assets/img/aquaman.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            }
                            {heroe.nombre === 'Batman' &&
                                    <img src={require('../../assets/img/batman.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            }
                            {heroe.nombre === 'Hulk' &&
                                    <img src={require('../../assets/img/hulk.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            }    
                            {heroe.nombre === 'Daredevil' &&
                                    <img src={require('../../assets/img/daredevil.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            }     
                            {heroe.nombre === 'Linterna Verde' &&
                                    <img src={require('../../assets/img/linterna-verde.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            } 
                            {heroe.nombre === 'Spider-Man' &&
                                    <img src={require('../../assets/img/spiderman.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            }    
                            {heroe.nombre === 'Wolverine' &&
                                    <img src={require('../../assets/img/wolverine.svg')}  alt={heroe.nombre} title={heroe.nombre} className="img-fluid shadow"></img>
                            }                                                                                                                                            
                            <br/><br/>
